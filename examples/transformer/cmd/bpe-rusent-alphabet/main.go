...
var fIn = "./examples/transformer/data/rus_sentences.txt"

// var fOut = "./examples/transformer/data/rus_sentences.alphabet"
var fOut = "./examples/transformer/cmd/bpe-rusent-alphabet/test"
