...
// Symm Multiplies a matrix by a symmetric matrix (double-precision).
func Symm(
...
// Gemv Multiplies a matrix by a vector (double precision).
...
// Ger Multiplies vector X by the transpose of vector Y, then adds matrix A (double precison).
