...
// DCopy Copies a vector to another vector (double-precision).
func DCopy(length int, src []float64, strideSrc int, dst []float64, strideDst int) {
...
// Daxpy Computes a constant times a vector plus a vector (double-precision).
func Daxpy(length int, alpha float64, src []float64, strideSrc int, dst []float64, strideDst int) {
...
// Dscal Multiplies each element of a vector by a constant (double-precision).
func Dscal(length int, alpha float64, src []float64, strideSrc int) {
...
// Dgemm Multiplies two matrices (double-precision).
func Dgemm(
...
// Dtrmm Scales a triangular matrix and multiplies it by a matrix.
func Dtrmm(
...
// Dsymm Multiplies a matrix by a symmetric matrix (double-precision).
func Dsymm(
...
// Dgemv Multiplies a matrix by a vector (double precision).
